        ...
        <div className="bg-dark">
            {/* <div className="container text-center text-white d-lg-flex py-5 border-top">
                ...
                <div className="mx-auto p-2 my-auto">
                    <Link className="navbar-brand d-none d-lg-block" to="/"><img className="w-25" alt="" /><span className="fw-bolder fs-3"> Rise<span className="logo-color">.</span>io</span></Link>
